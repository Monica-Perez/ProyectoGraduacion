        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?= URL ?>empresa/editar/<?= $empresa['ID_emp'] ?>">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control"
                                        value="<?= $empresa['Nombre_emp'] ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nit" id="nit" class="form-control"
                                        value="<?= $empresa['NIT_emp'] ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Sección de Contacto -->
                    <div class="form-section">
                        <h5 class="section-title"><i class="fas fa-address-book fa-rosado"></i> Información de Contacto
                        </h5>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contacto" id="contacto" class="form-control"
                                        value="<?= $empresa['Contacto_emp'] ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefono" id="telefono" class="form-control"
                                        value="<?= $empresa['Telefono_emp'] ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="direccion" id="direccion" class="form-control"
                                        value="<?= $empresa['Direccion_emp'] ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="correo" id="correo" class="form-control"
                                        value="<?= $empresa['Correo_emp'] ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
